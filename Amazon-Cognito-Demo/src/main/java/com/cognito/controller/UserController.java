...
import com.cognito.exception.CustomException;
import com.cognito.payload.UserDetail;
import com.cognito.payload.UserSignInRequest;
import com.cognito.payload.UserSignInResponse;
import com.cognito.payload.UserSignUpRequest;
...
public class UserController {
    ...
    public void signUp(@RequestBody UserSignUpRequest userSignUpRequest) {
        ...
        try {
            ...
            AdminCreateUserRequest userRequest =
                    new AdminCreateUserRequest().withUserPoolId(userPoolId).withUsername(userSignUpRequest.getUsername()).withTemporaryPassword(userSignUpRequest.getPassword()).withUserAttributes(emailAttr, emailVerifiedAttr).withMessageAction(MessageActionType.SUPPRESS).withDesiredDeliveryMediums(DeliveryMediumType.EMAIL);
            ...
            AdminSetUserPasswordRequest adminSetUserPasswordRequest =
                    new AdminSetUserPasswordRequest().withUsername(userSignUpRequest.getUsername()).withUserPoolId(userPoolId).withPassword(userSignUpRequest.getPassword()).withPermanent(true);
    ...
    public @ResponseBody UserDetail getUserDetail() {
        ...
        userDetail.setLastName("123");
        userDetail.setEmail("Test123@test.com");
        return userDetail;
    }
}
